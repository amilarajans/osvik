...
public interface InvoiceRepository extends JpaRepository<Invoice, Integer> {
    ...
    @Query(value = "SELECT new com.origins.osvik.dto.InvoiceDao(invoice.invoiceNo.invoiceNo,invoice.invoiceNo.client.name,invoice.invoiceNo.invoiceDate,invoice.invoiceNo.paymentMethod,invoice.invoiceNo.total) FROM Invoice invoice WHERE invoice.invoiceNo.invoiceNo = :invoiceNo OR (invoice.invoiceNo.client.code LIKE :clientCode AND invoice.invoiceNo.rep.name LIKE :repCode)")
